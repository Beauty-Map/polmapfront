...
<!--    <div class="w-full text-center font-light text-[16px] leading-[24px] text-[#828282]">IR - 43 0560 6118 2800 5585 3086 01</div>-->
    ...
    <div class="w-full flex flex-row flex-wrap justify-evenly items-center">
      <div class="flex flex-col justify-start items-center">
        <CircleProgressBar :value="user.withdraws" :max="user.all_income" colorUnfilled="#FF6832" size="120" rounded>
        ...
        <div v-format-number>{{ user.withdraws }}</div>
      </div>
      <div class="flex flex-col justify-start items-center">
        <CircleProgressBar :value="user.income" :max="user.all_income" colorUnfilled="#FFEA2E" size="120" rounded>
            <span class="w-[75px] flex flex-col justify-center items-center text-[13px] text-center">
        ...
        <div v-format-number>{{ user.income }}</div>
      </div>
    </div>
  </div>
</template>
