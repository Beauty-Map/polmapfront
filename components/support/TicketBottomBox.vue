<template>
  <div class="w-full max-w-[425px] mx-auto bg-white fixed bottom-0 py-[20px] px-[38px] left-0 right-0 border-t border-t-gray-500 flex flex-row justify-between items-center">
